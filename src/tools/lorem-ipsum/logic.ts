...
const LOREM_WORDS = [
  ...
  'provident', 'similique', 'mollitia', 'vitae', 'dicta', 'explicabo', 'nemo', 'ipsam',
  'quia', 'voluptas', 'aspernatur', 'aut', 'odit', 'fugit', 'totam', 'rem', 'aperiam',
];
...
export function generateLorem(
  ...
  if (startWithLorem && result && !result.toLowerCase().startsWith('lorem ipsum')) {
    if (type === 'words') {
