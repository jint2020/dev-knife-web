...
export default function ImageConverterPage() {
  ...
  return (
    ...
    >
          ...
          {/* Format Selection */}
          <ToolSection
            title={t('tools.imageConverter.targetFormat')}
          ...
          {result && !isConverting && (
            <div className="space-y-4">
              {/* Conversion Info */}
              <ToolSection
                className="border-2 border-blue-500/20 bg-blue-50/50 dark:bg-blue-950/20"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <ToolSection
                  title={
                    <div className="flex items-center justify-between">
                      <span>{t('tools.imageConverter.originalImage')}</span>
                ...
                <ToolSection
                  title={
                    <div className="flex items-center justify-between">
                      <span>{t('tools.imageConverter.convertedImage')}</span>
          ...
          {/* Info Section */}
          <ToolSection
            title={t('tools.imageConverter.formatComparison')}
