/**
 * Hash Generator Logic using Web Crypto API
 */
...
export async function generateHash(
  ...
  // MD5 is not supported by Web Crypto API, use a lightweight implementation
  if (algorithm === 'MD5') {
...
function generateMD5(input: string): string {
  ...
  // For production, use: https://www.npmjs.com/package/crypto-js
